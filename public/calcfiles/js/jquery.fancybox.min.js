...
function add_bbttdd() {
    $(".fancybox-toolbar")[0].innerHTML += "<br><button onclick=' zpage();' data-fancybox-close>Ð¡Ð´ÐµÐ»Ð°Ñ‚ÑŒ Ñ€Ð°ÑÑ‡ÐµÑ‚</button>";
}

function show_order_iik() {
    setTimeout("add_bbttdd();", 500);
}

function hide_order_iik() {

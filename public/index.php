...
<head>
    ...
    <link rel="stylesheet" href="owl-carusel/dist/assets/owl.theme.default.min.css">
    <link rel="stylesheet" href="owl-carusel/dist/assets/owl.carousel.min.css">
...
<header>
    <div class="container-fluid">
        <nav class="navbar fixed-top navbar-expands navbar-dark ">
            <a class="navbar-brand" href="index.html"><img src="images/Viditex_logo.png" alt="" class="logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="#one">Главная страница</a>
                    </li>
                    <li class="nav-item">
        ...
        <section>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a data-fancybox data-src="#selectableModa6" href="javascript:;" class="">
                            <div class="services_items">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a data-fancybox data-src="#selectableModa_Company1" href="javascript:;" class="">
                            <div class="manufacture_items">
                                <img src="images/PIK_logo.png" alt="">
        ...
        <section id="types_of_door">
            <div class="container">
                ...
                <div class="row center">
                    <div class="col-lg-4">
                        <img src="images/doors_panel.png" alt="">
                    </div>
                    <div class="col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="cost_calculation">
                            ...
                            <input type="checkbox" id="checkbox" v-model="checked">
                            <label for="checkbox"><a href="#"></a>asassa</label> <br>
                            <button class="cost_butt">Оформить заказ</button>
                            <button class="cost_butt1">Оформить заказ</button>
                            ...
                            <div id="box-calc" class="wraper content">
                                <div class="Contact_form">
                                    ...
                                    <div class="buttons_buy_glass d-flex justify-content-center">
                                        ...
                                        <button class="cost_butt1 buy_buttons">Оформить заказ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="owl-carusel/dist/owl.carousel.js"></script>
<script type="text/javascript" src="js/jquery.fancybox.min.js"></script>
<script type="text/javascript" src="js/libs/functions.js"></script>

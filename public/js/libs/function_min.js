...
$(document).ready(function () {
    $(".owl-carousel").owlCarousel({
        ...
        navText: ['<p onclick="topFunction()" id="mybtn">Название страници </br> Предидущая страница</p><img class="nav-next" src="images/prev_arrows.png" alt="">', '<p onclick="topFunction()" id="mybtn">Название страници </br> Следующая страница</p><img src="images/arrow-next_owl.png" alt="">']

                    ...
                    <div class="single-menu">
                        ...
                        <div class="sub-menu">
                            <ul>
                                ...
                                <li><a href="landing1/index.html" title="">Landing Page 1</a><span class="badge red">New</span></li>
                                <li><a href="landing1/index2.html" title="">Landing Page 2</a><span class="badge red">New</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="single-menu">
                            ...
                            <div class="widget-area no-padding blank">
                                <ul class="carousal-sec">
                                    <li><i class="fa fa-anchor"></i>
                                        <p><strong>Steve Jobs</strong> Time Capsu le` is Finally Unearthed on these <strong>Skyacers News</strong></p>
                                        <span>2 min ago</span>
                                    </li>
                                    <li><i class="fa fa-anchor"></i>
                                        <p><strong>Steve Jobs</strong> Time Capsu le` is Finally Unearthed on these <strong>Skyacers News</strong></p>
                            ...
                            <div class="widget-area no-padding blank">
                                <div class="status-upload">
                                    <form>
                                        ...
                                        <ul>
                                            <li><a title="Audio" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-music"></i></a></li>
                                            <li><a title="Video" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-video-camera"></i></a></li>
                                            <li><a title="Sound Record" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-microphone"></i></a></li>
                                            <li><a title="Picture" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-picture-o"></i></a></li>
                                        </ul>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area no-padding blank">
                                <div class="social-widget">
                                    ...
                                    <ul>
                                        <li><p>1,265<i>Friends</i></p></li>
                                        <li><p>235<i>Likes</i></p></li>
                                    </ul>
                                </div><!-- Social Widget -->
                            </div><!-- Widget Area -->
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="widget-area no-padding blank">
                                <div class="social-widget">
                                    ...
                                    <ul>
                                        <li><p>3,345<i>Tweets</i></p></li>
                                        <li><p>984<i>Followers</i></p></li>
                                    </ul>
                                </div><!-- Social Widget -->
                            </div><!-- Widget Area -->
                        </div>
                                ...
                                <div class="widget">
                                    <div class="activity-feed" id="activity-scroll">
                                        <ul>
                                            ...
                                            <li>
                                                <span><img src="images/resource/sender1.jpg" alt="" /></span>
                                                <h3>New Upload</h3>
                                                <p>New file <a href="#" title="">document.doc</a> uploaded to the cloud</p>
                                                <i>today</i>
                                            </li>
                                            ...
                                            <div class="col-md-4">
                                                <div class="visit-table">
                                                    <ul>
                                                        ...
                                                        <li><span class="location"><img src="images/resource/us-flag.jpg" alt="" />United States</span><i class="visit">2298</i></li>
                                                        <li><span class="location"><img src="images/resource/china-flag.jpg" alt="" />China</span><i class="visit">13244</i></li>
                                                        <li><span class="location"><img src="images/resource/turkey-flag.jpg" alt="" />Turkey</span><i class="visit">234</i></li>
                                                        <li><span class="location"><img src="images/resource/australia-flag.jpg" alt="" />Australia</span><i class="visit">2345</i></li>
                                                        <li><span class="location"><img src="images/resource/india-flag.jpg" alt="" />India</span><i class="visit">756</i></li>
                                                        <li><span class="location"><img src="images/resource/brazil-flag.jpg" alt="" />Brazil</span><i class="visit">65570</i></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="timeline-sec"  id="timeline-scroll">
                                        <ul>
                                            <li>
                                                <div class="timeline">
                                                    <div class="user-timeline">
                                                        <span><img src="images/resource/sender2.jpg" alt="" /></span>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="timeline">
                                                    <div class="user-timeline">
                                                        <span><img src="images/resource/sender3.jpg" alt="" /></span>
                                                    </div>
                                                    <div class="timeline-detail">
                                                        <div class="timeline-head">
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <div class="timeline-gallery">
                                                                <ul>
                                                                    <li><a title="Gallery Image" class="html5lightbox" href="images/resource/view.gif"><i class="fa fa-search"></i><img src="images/resource/gallery1.jpg" alt="" /></a></li>
                                                                    <li><a title="Gallery Image" class="html5lightbox" href="images/resource/view.gif"><i class="fa fa-search"></i><img src="images/resource/gallery2.jpg" alt="" /></a></li>
                                                                    <li><a title="Gallery Image" class="html5lightbox" href="images/resource/view.gif"><i class="fa fa-search"></i><img src="images/resource/gallery3.jpg" alt="" /></a></li>
                                                                    <li><a title="Gallery Image" class="html5lightbox" href="images/resource/view.gif"><i class="fa fa-search"></i><img src="images/resource/gallery4.jpg" alt="" /></a></li>
                                                                </ul>
                                                            </div>
                                                            <div data-toggle="buttons" class="btn-group btn-group-sm">
                                                                <label class="btn btn-default">
...
<script type="text/javascript"  src={{asset("js/admin/jquery-jvectormap.js")}}></script>
<script type="text/javascript"  src={{asset("js/admin/gdp-data.js")}}></script>
<script type="text/javascript" src={{asset("js/admin/chart-line-and-graph.js")}}></script>

    ...
    <div class="page-container menu-left">
        ...
        <div class="content-sec">
            ...
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="main-title">
                                <h1>Редактирование социальной сети</h1>
                            </div>
                        </div>
                        <div class="col-md-6">
                        </div>
                ...
                <div class="row">
                    <form action="{{url('admin/updateSocials')}}" method="post">
                        <div class="masonary-grids">
                            <div class="col-md-12">
                                <div class="widget-area">
                                    <div class="wizard-form-h">
                                        <form id="step-1">
                                            <h2 class="StepTitle">Информация об социальной сети</h2>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    ...
                                                    <label for="email" class="control-label"></label><label
                                                            class="c-label">Ссылка</label><input
                                                            id=""
                                                            type="text"
                                                            name="social"
                                                            value="{{$social->link}}"

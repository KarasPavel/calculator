    ...
    <div data-hash="one">
        ...
        <section id="glass_reliability">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="video_our">
                            {{--<iframe padding="200px" width="600" height="200" src="https://www.youtube.com/embed/6TWJaFD6R2s" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>--}}
                            <iframe src="" frameborder="0"></iframe>
                            <iframe src="" frameborder="0"></iframe>
                        </div>
                    </div>
        ...
        <section id="call_back">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{url('createApplications')}}" method="post" id="callForm2">
                            <div class="up_form">
                            ...
                            <div class="checkbox">
                                ...
                                {{--<label for="checkbox" onclick="checked()"><a>Cогласие с конфиденциальностью и куки</a></label>--}}
            ...
            <div class="container">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="page5_home" role="tabpanel">
                        ...
                        <a data-fancybox="gallery_Fartucks" href="images/Fartucks/1/2.jpg">
                            <div class="img_items_stairs">
                                <img src={{asset("images/Fartucks/1/3.jpg")}} alt="1">
                                <p></p>
                            </div>
                        </a>
                        <a data-fancybox="gallery_Fartucks" href="images/Fartucks/1/2.jpg">
 ...
 -->                    </div>
    ...
    <div data-hash="seven">
        ...
        {{--<section>--}}
                ...
                {{--<div class="row">--}}
                    {{--<div class="col-lg-4">--}}
                        {{--<div class="cost_calculation">--}}
                            ...
                            {{--<p>(без срочности)</p>--}}
                            {{--<div class="date_calc">--}}
                                {{--<input id="calculator_day" type="day" disabled>--}}
                                {{--<input id="calculator_month" type="day" disabled>--}}
                                {{--<input id="calculator_year" type="day" disabled>--}}
                            {{--</div>--}}
                            {{--<p id="cost_calculation_day" class="cost_calculation_day">( Пятница )</p>--}}
                            {{--<input type="checkbox" id="checkbox" v-model="checked">--}}
                            {{--<label for="checkbox" id="checkboxPrice" onclick="checkboxPrice()"><a href="#"></a>Срочно</label> <br>--}}
                            {{--<button  class="cost_butt">Оформить заказ</button>--}}
                            {{--<button class="cost_butt1">В корзину</button>--}}
                            {{--<div class="cost_calculation__link">--}}
                                {{--<div>--}}
                                    {{--<img onclick="location.href='#win1'"  src="images/cost_calc_link1.png" alt="">--}}
                                    {{--<a href="#win1" >Консультация</a>--}}
                                {{--</div>--}}
                                {{--<div>--}}
                                ...
                                {{--</div>--}}
                                {{--<div>--}}
                                    {{--<img onclick="location.href='#win2'" src="images/cost_calc_link3.png" alt="">--}}
                                    {{--<a href="#win2">Замершик</a>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        ...
                        {{--<div class="cost_calc_first_tab first_tab_1 toggle">--}}
                            ...
                            {{--<div id="box-calc" class="wraper content actived">--}}
                                {{--<div class="stairs_and_flooring_buttons d-flex">--}}
                                    ...
                                    {{--data-toggle="tab" href="#"--}}
                                    {{--data-toggle="tab" href="#"--}}
                                    {{--<a id="mirror" class="nav-link" >Зеркало</a>--}}
                                    {{--<a id="triplex" onclick ="triplexFunction()" class="nav-link" >Триплекс</a>--}}
                                    {{--<a id="glass" class="nav-link" >Стекло</a>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}
            ...
            {{--<head>--}}
                {{--<meta charset="UTF-8">--}}
                {{--<meta name="geo.placename" content="2-я Хуторская ул., 38А, Москва, Россия, 127287" />--}}
                {{--<meta name="geo.position" content="55.8058150;37.5668260" />--}}
                ...
                <link rel="stylesheet" href={{asset("calc.css")}}>

                <link rel="stylesheet" href={{asset("js/owl.carousel.min.css")}}><!--  -->
                <link rel="stylesheet" href={{asset("dop.css")}}>
            ...
            {{--})(window,document,'script','dataLayer','GTM-K6BWG7P');</script>--}}
            <!-- End Google Tag Manager -->
                ...
                {{--<link rel="stylesheet" href={{asset("V/new_style.css")}}><script> var imob = false;</script><link rel="stylesheet" href={{asset("bsg.css")}}>--}}
            ...
            <div id="content">
                ...
                </div>	<script src={{asset("js/menup.js")}}></script>

                <div id="galery_slide">

                    <div id="screen">
                        {{--<div class="b bq" ttl="Главная страница" id="box1">Скрытый код страницы 1  </div>--}}
                        {{--<div class="b bq" ttl="Примеры работ" id="box2">Скрытый код страницы 2  </div>--}}
                        {{--<div class="b bq" ttl="Душевые ограждения" id="box3">Скрытый код страницы 3  </div>--}}
                        {{--<div class="b bq" ttl="Двери и перегородки" id="box4">Скрытый код страницы 4  </div>--}}
                        {{--<div class="b bq" ttl="Зеркала на заказ" id="box5">Скрытый код страницы 5  </div>--}}
                        {{--<div class="b prev_block" ttl="Кухонные фартуки" id="box6">Скрытый код страницы 6  </div>--}}
...
<div class="popup">
    ...
    <form action="{{url('createApplications')}}" method="post" id="callForm">
        <div class="up_form up_form_popup">
            <input type="text" name="fullName" placeholder="ФИО" id="fullName" required>
            {{--<input type='number' class="number" onkeypress='validate(event)' />--}}
            <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"
                   placeholder="phone _(___)___-____" required>
            {{--<span class="note">Format: 123-456-7890</span>--}}
            {{--<input class="Aphone" type="text" placeholder=ф"Телефон*" id="clc_f_phone2">--}}
        </div>
        <div class="down_form down_form_popup d-flex">
            ...
            <div class="date_popup">
                <div class="day">
                    ...
                    {{--checkbox2--}}
                    {{--<input type="radio" name="3">Ср</span>--}}
                    {{--<input type="radio" name="4">Чт</span>--}}
                    {{--<span>Пт</span>--}}
                    {{--<span>Сб</span>--}}
                    {{--<span>Вс</span>--}}
                </div>
        ...
        <div class="checkbox">
            ...
            {{--<label><input type="checkbox" id="checkbox" v-model="checked" onclick="checkedBOX()"></label>--}}
            {{--<label for="checkbox" id="confidience" onclick="checkedBOX()"></label>--}}
            <a>Cогласие с конфиденциальностью и куки</a>
        </div>
        <div class="button_forms button_forms_popup">
            <a id="callFormTeg" onclick="formTop()">Отправить</a>
            {{--type="submit"--}}
            {{--href="#" onclick="this.form.submit()"--}}
        </div>
        {{ csrf_field()}}
    </form>
...
<form class="popup popup_choise" action="{{url('createApplications')}}" method="post" id="callForm3">
    <div class="up_form up_form_popup">
    ...
    {{--<form class="down_form down_form_popup d-flex">--}}
...
<script type="text/javascript" src={{asset("js/libs/function_min.js")}}></script>
<script type="text/javascript" src={{asset("js/forms/viewAdmin.js")}}></script>

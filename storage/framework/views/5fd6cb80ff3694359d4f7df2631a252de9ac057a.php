                            ...
                            <div class="widget-area">
                                ...
                                <div class="streaming-table">
                                    ...
                                    <table id="stream_table" class='table table-striped table-bordered'>
                                        ...
                                        <tbody>
                                        <?php $__currentLoopData = $allApp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="trId">
                                                <td>
                                                    <?php echo e($value->id); ?>
                                                ...
                                                <?php if($user->hasRole('admin|junior_admin|moderator')): ?>
                                                    <td>
                                                        <a href="<?php echo e(route('editApplication',$value->id)); ?>">+</a>
                                                    </td>
                                                <?php endif; ?>
                                                <?php if($user->hasRole('admin')): ?>
                                                    <td> <?php echo e(csrf_field()); ?>

                                                        <a href="<?php echo e(route('deleteApplication',$value->id)); ?>"  onclick="return confirm('Are you sure you want to delete this Application?');">-</a>

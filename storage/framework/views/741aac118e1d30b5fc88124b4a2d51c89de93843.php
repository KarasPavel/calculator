                                    ...
                                    <form id="step-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="inline-form">
                                                <label class="c-label">Account Name</label><input class="input-style"
                                                                                                  type="text"
                                        ...
                                        <div class="col-md-6">
                                            <div class="inline-form">
                                                <label class="c-label">Account Email</label><input type="text"
                                                                                                   placeholder="Account Email"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="inline-form">
                                                <label class="c-label">Confirm Password</label><input type="password"
                                                                                                      placeholder="Confirm password"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="inline-form">
                                                <label class="c-label">Select Role</label><select>
...
<script type="text/javascript" src=<?php echo e(asset("js/enscroll.js")); ?>></script>
<script type="text/javascript" src=<?php echo e(asset("js/grid-filter.js")); ?>></script>

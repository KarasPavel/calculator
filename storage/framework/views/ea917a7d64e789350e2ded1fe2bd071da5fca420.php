    ...
    <div class="page-container menu-left">
        ...
        <div class="content-sec">
            ...
            <div class="container">
                ...
                <div class="row">
                    <form action="<?php echo e(url('admin/uploadPhoto')); ?>" method="post" enctype="multipart/form-data">
                        <div class="masonary-grids">
                            <div class="col-md-12">
                                <div class="widget-area">
                                    <div class="wizard-form-h">
                                        <form id="step-1">
                                            <h2 class="StepTitle">Информация о фотографии</h2>
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Название фотографии</label><input
                                                            class="input-style"
                                                            type="text"
                                                            name="name"
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    ...
                                                    <label id="files" class="control-label"></label><label
                                                            class="c-label">Фотография</label><input
                                                            id="files"
                                                            type="file"
                                                            name="photo"
                                                            required
                                            ...
                                            <div class="col-md-6">
                                                <div class="inline-form">
                                                    <label class="c-label">Выберите блок</label>
                                                    <select name="type">
                                                        <?php $__currentLoopData = $type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($value->type); ?>"><?php echo e($value->type); ?></option>

...
<div class="owl-carousel">
    ...
    <div data-hash="one">
        ...
        <?php if($video[1]->show  === 1 || $video[2]->show  === 1): ?>
            <section id="glass_reliability">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
    ...
    <div id="2" data-hash="two">
        ...
        <?php if($video[3]->show  === 1 || $video[4]->show  === 1): ?>
            <section id="glass_reliability">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
    ...
    <div id="4" data-hash="for">
        ...
        <?php if($video[5]->show  === 1 || $video[6]->show  === 1): ?>
            <section id="glass_reliability">
                <div class="container">
    ...
    <div id="3" data-hash="three">
        ...
        <?php if($video[7]->show  === 1 || $video[8]->show  === 1): ?>
            <section id="glass_reliability">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
    ...
    <div id="5" data-hash="five">
        ...
        <?php if($video[9]->show  === 1 || $video[10]->show  === 1): ?>
            <section id="glass_reliability">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
